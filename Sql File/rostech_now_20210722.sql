...
--
-- Truncate table before insert `harga`
--
...
--
-- Truncate table before insert `iip`
--
...
(237, '13.213.222.182', 'aktif', '2021-07-22 14:08:10', '3efef586e06703e54a2c92d9a701b7d2', NULL);
...
--
-- Truncate table before insert `ilogin`
--

TRUNCATE TABLE `ilogin`;
--
...
--
-- Truncate table before insert `toko`
--
...
--
ALTER TABLE `material`
  MODIFY `mid` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=205;
